 ...
 */
export function buildRichText(builder: StringBuilder | undefined, text: unknown, color?: Color3, size?: number, weight?: string | number) {
    if (builder === undefined)
        builder = new StringBuilder("<font");
 ...
 */
export function formatRichText(text: unknown, color?: Color3, size?: number, weight?: string | number) {
